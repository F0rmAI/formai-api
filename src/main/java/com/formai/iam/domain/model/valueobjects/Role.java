 ...
 * <p>
 * Add new values here for any additional access tier the domain needs (e.g.
 * SUPPORT_AGENT, BILLING_MANAGER), and wire the corresponding SecurityConfig
 * matcher — see the example there.
 */
public enum Role {
    REGISTERED_USER,
    ADMINISTRATOR
